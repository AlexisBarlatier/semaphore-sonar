    ...
    "analyse": {
        ...
        "strategies_explorees": [
            ...
            {"strategie": "Revente à la découpe des quatre T2", "lots": 4,
             "rendement": "marge brute d'environ 30 000 €",
             "faisabilite": "division en copropriété à créer (état descriptif de division et règlement)",
             "risque": "élevé — 10 000 € et 6 à 9 mois de procédure, et le prix au détail se paie sur la durée dans une commune de 12 000 habitants"},
...
{rows_p}
    ...
    gen.CONF = {SLUG: dict(
        ...
        rationale=(
            ...
            "Les deux autres pistes méritaient d'être chiffrées. La <strong>revente à la découpe</strong> : les quatre T2 "
            "représentent 160 m² qui valent environ 456 000 € au prix du marché communal, soit 428 000 € nets d'honoraires, "
            "contre 312 960 € de prix de revient — une marge brute d'environ 30 000 € après frais de division, mais il faut "
            "créer une copropriété (10 000 €, six à neuf mois) et vendre quatre lots dans une commune de 12 000 habitants. "
            "Rentable sur le papier, long et incertain en pratique : écartée au profit de la conservation. "
