...
def build(records):
    ...
    html = (
        ...
        '<p style="margin:14px 0 22px;font-size:14px">'
        '<a href="marches-locaux/index.html" style="color:#1d4e79;font-weight:700">'
        'Seuils d\'achat par ville &mdash; fiche de référence (12 communes)</a></p>'
